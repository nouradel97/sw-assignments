...
public class TestingForStudentSignUp {

    private WebDriver driver;

    @DataProvider(name = "validInput")
    public Object[][] validInput(){ return new Object[][]{{"yasmin","sayed","yasmin21","Giza","123"
            ,"011111","123456"}}; }

    @DataProvider(name = "invalidInput")
    public Object[][] invalidInput(){

        return new Object[][]{{"yasmin","sayed","jahidd26","Giza","123","011111","123456"},
            {"yasmin","sayed","yasmin21","Giza","","011111","ay7aga"},
            {"yasmin","sayed","yasmin21","Giza","123","011111",""},
            {"yasmin","","yasmin21","Giza","123","011111","123456"},
            {"","sayed","yasmin21","Giza","123","011111","123456"},
            {" "," "," "," "," "," "," "},
            {"yasmin","sayed","","Giza","123","011111","123456"},
                {"yasmin","sayed","yasmin21","Giza","123","contact","123456"}};
    }

    @BeforeMethod
    public void openLoginPage(){

        driver.get("http://localhost/library/student_form.php");
    ...
    public void validTest(String fname, String lname, String username,
                          String address, String rollin, String contact, String password){
        ...
        driver.findElement(By.name("roll")).sendKeys(rollin);
    ...
    public void invalidTest(String fname, String lname, String username,
        ...
        driver.findElement(By.name("submit")).click();
        assertEquals(driver.getCurrentUrl(),"http://localhost/library/student_form.php");
    }
